    ...
    <>
        <div className="relative flex flex-col items-center"
            >
              ...
              <div className="absolute rounded-b-[12.5rem] w-[17.5rem] h-[11.75rem] bg-secondary -bottom-0 z-10 lg:w-[17.3rem] lg:h-[10rem] xl:w-[17.5rem] xl:h-[11.5rem]"></div>

              {/* Name and Role Box */}
              <div className="absolute bottom-10 lg:bottom-8 xl:bottom-10 rounded-b-[12.5rem] h-[6.563rem] w-[13.125rem] lg:w-[11rem] lg:h-[6.5rem] xl:h-[6.563rem] xl:w-[13.125rem] text-center bg-white pt-6 z-30">
