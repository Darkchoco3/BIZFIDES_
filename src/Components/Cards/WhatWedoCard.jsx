const WhatWedoCard = ({what, i}) => {
  return (
    <div className='min-h-[474px] rounded-[55px] shadow-[0px_0px_12px_8px_rgba(0,0,0,0.02)] p-4 font-inter flex flex-col gap-[24px] border border-neutral-grey-100' key={i}>
