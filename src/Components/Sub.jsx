    ...
    <>
      <div className="bg-primary">
        <div className="container w-11/12">
          ...
          <div>
            <div className="grid grid-cols-1 lg:grid-cols-3 xl:grid-cols-7 place-items-center gap-10 pt-3">
              ...
              <img src={arrow} alt="" className="hidden lg:hidden xl:block"/>
              <img src={arrowMobile} alt="" className="block lg:hidden xl:hidden"/>
