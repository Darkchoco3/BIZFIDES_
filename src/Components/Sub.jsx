...
const Sub = () => {
    return (
        ...
        <div className="container max-w-[77.5rem] bg-primary p-2 ">
            ...
            <div className="w-[100%]  mx-auto relative text-white border-spacing-5 border-dashed border-gray-500 pt-8 hidden md:block  ">
                <span className="text-2xl mr-2 absolute left-[20%] top-16 lg:inline md:hidden ">{'----------->'}</span>
                <span className="text-2xl mr-2 absolute right-[45%] top-16 lg:inline md:hidden">{'----------->'}</span>
                <span className="text-2xl mr-2 absolute right-[20%] top-16 lg:inline md:hidden">{'----------->'}</span>
            </div>
          

            <div className=" w-[100%] grid md:grid-cols-2 lg:grid-cols-4  justify-between gap-8 p-4  h-[120vh] md:h-auto md:flex-wrap  ">
                <div className="flex justify-between lg:justify-center lg:flex-col items-center relative ">
                    ...
                    <div className='flex flex-col text-white items-center    absolute md:hidden top-40 left-10  '>
                    <span>|</span>
                    <span>|</span>
                    <span>|</span>
            ...
            <div className="flex  items-center p-4 flex-shrink-0 ">
                <img src={image1} alt="" className='filter invert w-10 h-auto  brightness-0' />
            </div>
