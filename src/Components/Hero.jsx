...
const Hero = () => {
  return (
    <div className='bg-primary  pt-[6rem] md:pt-28 lg:pt-[7rem]'>
       <div className="container max-w-[77.5rem] min-h-[384px] md:min-h-[484px]  lg:min-h-[544px] relative flex flex-row justify-center lg:justify-between  items-center">
       <div className="absolute  lg:static z-20 space-y-8  lg:w-1/2  flex flex-col justify-center items-center lg:items-start h-[25rem] lg:h-auto ">
        <h3 className=' font-medium font-roboto text-xl md:text-2xl lg:text-[1.75rem] text-white'>Small Business. Big Impact.</h3>
        <h1 className='font-bold font-roboto text-4xl md:text-6xl text-center lg:text-start text-primary-light'>Build Your Online Presence Today.</h1>
        ...
        <div className="relative h-[24rem] w-[60%] md:h-[30rem] lg:h-auto  md:w-[50%] lg:w-auto -right-[6.5rem] md:-right-[19.1rem] lg:-right-11">
           
            <img src={Polygon2} className="h-full w-full" alt="" />
          
            <div className="absolute z-10 top-[4rem] md:top-[4.1rem] lg:top-[3.4rem] -right-[1px] md:-right-0 lg:-right-0 w-[97%] md:w-[100%] lg:w-auto h-[20rem] md:h-[26rem] lg:h-auto">
