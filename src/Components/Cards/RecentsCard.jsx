...
const RecentsCard = ({
  ...
  // Use state that will work with scren sizes
  ...
  return (
    <>
      <div className="w-full min-h-[22rem] shadow-[0px_0px_12px_8px_rgba(0,0,0,0.02)] border border-neutral-grey-100 rounded-[3.5rem] xl:rounded-[6.25rem] p-8 lg:p-0 lg:px-5 flex flex-col lg:flex lg:flex-row-reverse lg:gap-4 xl:grid xl:grid-cols-2 gap-[1.813rem] items-center"> 
        <img
